namespace Logistica.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Logistica.Models.LogisticaDB>
    {
        ...
        protected override void Seed(Logistica.Models.LogisticaDB context)
        {
            ...
            {
                new Cotacoes{ID = 0, Pedido = pedidos[0], Pedidofk = 0, Transportadora = transportadores[0], Transportadorafk = 0,  valorCotacao = "10,2", Aceite = false},
                new Cotacoes{ID = 1, Pedido = pedidos[1], Pedidofk = 1, Transportadora = transportadores[1], Transportadorafk = 1,  valorCotacao = "20,3", Aceite = false},
                new Cotacoes{ID = 2, Pedido = pedidos[2], Pedidofk = 2, Transportadora = transportadores[2], Transportadorafk = 2,  valorCotacao = "30,2", Aceite = false},
                new Cotacoes{ID = 3, Pedido = pedidos[3], Pedidofk = 3, Transportadora = transportadores[3], Transportadorafk = 3,  valorCotacao = "40,6", Aceite = false},
                new Cotacoes{ID = 4, Pedido = pedidos[4], Pedidofk = 4, Transportadora = transportadores[4], Transportadorafk = 4,  valorCotacao = "50,0", Aceite = false}
            };
